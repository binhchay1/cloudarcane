...
<div class="grid-image big-wrap">
	<?php if (has_post_thumbnail() || is_myarcade_game()) : ?>
		<?php $image = '<a href="' . get_permalink() . '">' . get_the_post_thumbnail(get_the_ID(), 'blog-square') . '</a>'; ?>
	...
	?>
		<a href="<?php the_permalink(); ?>" title="<?php the_title(); ?>" class="img-thumb-game-with-video">
			<img src="<?php echo get_post_meta(get_the_ID(), 'game_thumb1')[0] ?>" width="270" height="235" alt="<?php the_title(); ?>" />
