...
-----------------------------------------------------------------------------------------------------------*/
    ?>
      ...
      <h4 style="line-height: 20px;">
        <div class="dashicons dashicons-editor-alignleft" style="padding-right:5px"></div><?php _e('Slider Options', 'gameleon'); ?>
      </h4>
...
-----------------------------------------------------------------------------------------------------------*/
    ?>
      ...
      <h4 style="line-height: 20px;">
        <div class="dashicons dashicons-editor-alignright" style="padding-right:5px"></div><?php _e('Left Module Options', 'gameleon'); ?>
      </h4>
      ...
      <h4 style="line-height: 20px;">
        <div class="dashicons dashicons-editor-alignleft" style="padding-right:5px"></div><?php _e('Right Module Options', 'gameleon'); ?>
      </h4>
      ...
      <h4 style="line-height: 20px;">
        <div class="dashicons dashicons-admin-generic" style="padding-right:5px"></div><?php _e('Other Options', 'gameleon'); ?>
      </h4>
...
-----------------------------------------------------------------------------------------------------------*/
    ?>
      ...
      <h4 style="line-height: 20px;">
        <div class="dashicons dashicons-editor-alignleft" style="padding-right:5px"></div><?php _e('Module Options', 'gameleon'); ?>
      </h4>
          ...
          <div class="td-fly-in">
            ...
            <div class="grid col-340">
              <div class="td-post-details-3">
                <?php $i = 0; ?>
                <?php while ($recent_posts->have_posts()) : $i++;
                  if (($i % 2) == 0) : $wp_query->next_post();
                  else : $recent_posts->the_post(); ?>
      ...
      <div class="td-content-inner td-module-6">
        ...
        <div class="td-wrap-content">
          <div class="td-fly-in">
            ...
            $recent_posts = new WP_Query($argsPopular);
            $temp_query = $wp_query;
            $wp_query = null;
            $wp_query = $recent_posts;
            ?>
            ...
            <?php while ($recent_posts->have_posts()) : $recent_posts->the_post(); ?>
              ...
              <div class="grid col-340 <?php if ($counter % 3 == 1) {
                                          echo 'td-no-fit';
                                        } else if ($counter % 3 == 0) {
                                          echo 'fit';
                                        } ?>">
        ...
        <div class="td-wrap-content">
          <div class="td-fly-in">
            ...
            <?php while ($recent_posts->have_posts()) : $recent_posts->the_post(); ?>
              ...
              <div class="grid col-520 <?php if ($counter % 2 == 1) {
                                          echo 'td-no-fit';
                                        } else if ($counter % 2 == 0) {
                                          echo 'fit';
                                        } ?>">
...
-----------------------------------------------------------------------------------------------------------*/
    ?>
      ...
      <h4 style="line-height: 20px;">
        <div class="dashicons dashicons-editor-alignleft" style="padding-right:5px"></div><?php _e('Carousel Options', 'gameleon'); ?>
      </h4>
